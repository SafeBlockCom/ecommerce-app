...
const Category = () => {
  ...
  const toggleSubChildCategory = () =>
    setIsSubChildCategoryOpen(!isSubChildCategoryOpen);
              ...
              <ul className="category-list">
                <li className="option">
                  <a
                    href={null}
                    onClick={() =>
                      updateCategory({ label: "All Products", value: "all" })
                    }
                    className="ptCatFilOpt"
                  >
                    All products
                  </a>
                </li>
                {HELPER.isNotEmpty(categories) &&
                        ...
                        <li key={`category-` + i} className="option">
                          ...
                          {HELPER.isNotEmpty(category.children) ? (
                            <div className="optionAction">
                              <i
                                className="fa fa-chevron-down text-right"
                                aria-hidden="true"
                                      ...
                                      {HELPER.isNotEmpty(
                                        ...
                                        <div className="subOptionAction">
                                          <i
                                            className="fa fa-chevron-down text-right"
                                            aria-hidden="true"
                                            onClick={toggleSubChildCategory}
                                          ></i>
                                        </div>
                                      ) : (
                                        ""
