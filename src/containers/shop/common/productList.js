            ...
            <Row>
              <Col xs="12">
                <ul className="product-filter-tags">
                  ...
                  {HELPER.isNotEmpty(selectedCondition) &&
                    condition.map((conditionVal, i) => {
                          ...
                          <li key={i}>
                            <a href={null} className="filter_tag">
                              ...
                              <i
                                className="fa fa-close"
                                onClick={() =>
                                  removeCondition(conditionVal?.value)
                                }
                              ></i>
                            </a>
                          </li>
                  ...
                  {HELPER.isNotEmpty(selectedStandard) &&
                    standard.map((standardVal, i) => {
                          ...
                          <li key={i}>
                            <a href={null} className="filter_tag">
                              ...
                              <i
                                className="fa fa-close"
                                onClick={() =>
                                  removeStandard(standardVal?.value)
                                }
                              ></i>
                            </a>
                          </li>
                  ...
                  {price_range.selectedPrice?.max > 0 ?? (
                    <li>
                      <a href={null} className="filter_tag">
                        price: {price_range.selectedPrice.min}-{" "}
                        {price_range.selectedPrice.max}
                      </a>
                    </li>
                  )}
                </ul>
                        ...
                        <div className="product">
                          <div>
                            <ProductItem
                              des={true}
                              product={product}
                              symbol={currencyContext.selectedCurr.symbol}
