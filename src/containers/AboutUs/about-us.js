...
const TeamDetailData = [
  {
    ...
    name: "john doe",
    post: "designer",
    about: "Sometimes your only available transportation is a leap of faith.",
  },
  {
    img: IMAGE_SRC.AVATAR,
    name: "john doe",
        ...
        <section className="about-page section-b-space">
          <Container>
            <Row>
              ...
              <Col sm="12">
                <h4>
                  A flower knows, when its butterfly will return, and if the
                  moon walks out, the sky will understand
                </h4>
                <p>
