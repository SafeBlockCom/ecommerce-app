...
const LoginMobileVerification = () => {
  ...
  const { authLoading, isVerificationAttempt } = useSelector(
    (state) => state.auth
  );
  ...
  const handleValidation = () => {
    ...
    if (!HELPER.isEmpty(phoneNumber) && isValidNumber(phone.number) === false) {
      errors.phone_number = "The number is invalid";
    }
    setError(errors);
    return errors;
  };
      ...
      <div className="d-flex bg-white justify-content-center align-items-center">
        <div className="app-login-box">
          ...
          <h4 className="mb-0">
            ...
            <span className="mb-2">We need to verify your account.</span>
          </h4>
                          ...
                          >
                            ...
                            >
                              <PhoneNumberComponent
                                ...
                                error={
                                  !HELPER.isEmpty(error.phone_number)
                                    ? true
                                    : false
                                }
