...
const NavBar = () => {
  ...
  const navigationAction = (event, action) => {
    ...
    dispatch(
      MENU_ITEM_ACTIONS.REQUEST_MENU_ITEM({
        action: action,
        path: "shop",
        router: {
    ...
    // navigate(`${ROUTE_CONSTANTS.SHOP}?${searchParams}`);
  };
                  ...
                  >
                    {menuItem.type == "link" ? (
                      ...
                      <a
                        href="#"
                        className="nav-link"
                        onClick={(e) => openMblNav(e, menuItem)}
                      >
                        {t(menuItem.title)}
                        {menuItem.children ? (
                    ...
                    {HELPER.isNotEmpty(menuItem.children) &&
                    !menuItem.megaMenu ? (
                              ...
                              >
                                {childrenItem?.type === "sub" ? (
                                  <a
                                    ...
                                    className="nav-link"
                                    onClick={(e) =>
                                      toggletNavActive(e, childrenItem)
                                    }
                                  >
                                    {childrenItem.title}
                                ...
                                {childrenItem?.type === "link" ? (
                                  <a
                                    href={"#"}
                                    onClick={(e) =>
                                      navigationAction(e, childrenItem)
                                    }
                                  >
                                    {childrenItem.title}
                                    {childrenItem.tag === "new" ? (
                                ...
                                {HELPER.isNotEmpty(childrenItem?.children) &&
