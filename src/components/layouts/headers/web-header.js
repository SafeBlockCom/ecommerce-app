          ...
          <Row>
            <Col md={3} sm={3}>
              <Row className="lookbook-img">
                <Banners
                  bannerItem={caraouselBanner.slice(0, 1)}
                  keyIndex={1}
                />
                <Banners
                  bannerItem={caraouselBanner.slice(1, 2)}
                  keyIndex={2}
                />
              </Row>
            </Col>
            ...
            <Col md={3} sm={3}>
              <Row className="lookbook-img">
                <Banners
                  bannerItem={caraouselBanner.slice(2, 3)}
                  keyIndex={4}
                />
                <Banners
                  bannerItem={caraouselBanner.slice(3, 4)}
                  keyIndex={5}
                />
              </Row>
            </Col>
...
const Banners = (props) => {
  ...
  return (
    <Col
      sm="12"
      className="lookbook-parent"
      key={`lookbook-parent-${bannerItem[0]?.index}`}
    >
      <div className="lookbook-block">
        ...
        <div className={`lookbook-img-section img-${keyIndex}`}>
          ...
          <div
            onClick={() =>
              navigate(
                `${ROUTE_CONSTANTS.CATEGORY_WITH_SLUG}/${bannerItem[0]?.slug}`
              )
            }
