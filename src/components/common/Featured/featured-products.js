    ...
    <>
      <div className="product-box product-wrap">
        <div className="img-wrapper">
          ...
          <div className="front" onClick={clickProductDetail}>
            <Media src={`${product.image}`} className="img-fluid" alt="" />
          </div>
            ...
            <Row>
              ...
              <Col lg="6" className="rtl-text">
                <div className="product-right">
                  <h2> {product.title} </h2>
                  <h3>{`${symbol} ${(product.price * currency.value).toFixed(
                    2
                  )}`}</h3>
                  {product.variants ? (
      ...
      <div className="product-box product-wrap d-none">
        ...
        <div className="product-info">
          ...
          <h6>{product.name}</h6>
          <h4>
            {`${symbol} ${product.discounted_price.toFixed(2)}`}
            <del>
        ...
        >
          <ModalBody>
            <Row>
              <Col lg="6" xs="12">
                <div className="quick-view-img">
                  <Media src={product.image} alt="" className="img-fluid" />
                </div>
              </Col>
              <Col lg="6" className="rtl-text">
                <div className="product-right">
                  <h2> {product.name} </h2>
                  <h3>{`${symbol} ${product.price.toFixed(2)}`}</h3>
                  {/* {product.variants ? (
                    <ul className="color-variant">
                      {uniqueTags ? (
                        <ul className="color-variant">
