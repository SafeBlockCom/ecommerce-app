...
import { HELPER, history } from "../../../../utils";
...
export function SellerWatchList() {
  ...
  return (
    <Container>
      {HELPER.isNotEmpty(sellersWatchList) &&
        sellersWatchList.map((item) => {
          return (
            <Row className="closet media d-flex align-center">
              ...
              <Col
                ...
                md="8"
                sm="8"
                className="text-left seller-closet"
              >
