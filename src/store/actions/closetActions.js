...
import { CLOSET_CONSTANTS, CUSTOMER_CONSTANTS } from "../actionTypes";
...
function CLOSET_ASSETS_UPLOAD(requestData) {
    ...
    apiService
      ...
      .catch((error) => {
        ...
        if (error_response === undefined) {
          dispatch(ALERT_ACTIONS.error(error_message));
        }
  ...
  function success(data) {
    return { type: CUSTOMER_CONSTANTS.PROFILE_SUCCESS, response: data };
  }
  function failure() {
