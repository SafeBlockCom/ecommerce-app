import { CONSTANTS, COOKIE_STORAGE_SERVICE, HELPER } from "../../utils";
    ...
    apiService
      ...
      .then((response) => {
        ...
        if (
          ...
          COOKIE_STORAGE_SERVICE._updateAccessToken(
      ...
      .catch((error) => {
        const { errorResponse, error_message, errorBody } =
          HELPER.formatFailureApiResponse(error);
